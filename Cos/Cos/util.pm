...
sub send_header {
    ...
    if ($Authenticated) {
	  ...
	  my @cookie = Cos::util::del_cookie("Username","Password");
	  print $cgi->header(
			-charset=>'utf-8',
			-cookie=>[ @cookie ]
	  );
...
sub send_footer {
    ...
    if ($Authenticated) {
	    ...
	    # create the link to the main menu
	    print "<a href=\"login.cgi\">Login</a>\n";
	    print "</BODY></HTML>\n"
    }
...
sub send_ord_footer {
    ...
    # create the link to the home page
    print '<a href=/>Optical Online Home</a>&nbsp;';
    print '&gt;' x 3;
    print '&nbsp;'."\n";

    # create the link to the main menu
    print '<a href="index.cgi">Main Menu</a>&nbsp;';
    print '&gt;' x 3;
    print '&nbsp;'."\n";
...
sub user_error {
    ...
    send_header("Problem Encountered: $error",$redir);
