...
my $enableDigital   = $LabRetailer->{enableDigital} || 'N';
...
my $displayPPMedicaidID  = $LabRetailer->{displayPPMedicaidID} || 'Y';
my $displayDPMedicaidID  = $LabRetailer->{displayDPMedicaidID} || 'Y';
my $displayPAMedicaidID  = $LabRetailer->{displayPAMedicaidID} || 'Y';
my $displayPARecDate  = $LabRetailer->{displayPARecDate} || 'Y';
my $displayPANumber  = $LabRetailer->{displayPANumber} || 'Y';
my $displayPAReason  = $LabRetailer->{displayPAReason} || 'Y';
my $displayPADCode  = $LabRetailer->{displayPADCode} || 'N';
...
displayPPMedicaidID = $displayPPMedicaidID
displayDPMedicaidID = $displayDPMedicaidID
displayPAMedicaidID = $displayPAMedicaidID
displayPARecDate = $displayPARecDate
displayPANumber = $displayPANumber
displayPAReason = $displayPAReason
displayPADCode = $displayPADCode
